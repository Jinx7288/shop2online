<template>
  <div class="warp_for_login">
    <div class="box">
      ...
      <el-row>
        <el-col :span="24"
          ><el-button type="danger" plain @click="switchto"
            >还未注册？点击注册</el-button
          ></el-col
        >
      </el-row>
      <el-row>
        <el-col :span="12" :offset="0"
          ><el-button type="text" plain @click="justExplore"
            >仅浏览商品</el-button
          ></el-col
        >
        <el-col :span="12" :offset="0"
    ...
    <el-button @click="turntoml" size="medium" type="danger" style="width: 10%"
      >Manager Login</el-button
    >
  </div>
</template>
  ...
  methods: {
    ...
    login: function () {
      ...
      if (
        ...
        checkpw(that.logininfo.password)
      ) {
        this.$http
